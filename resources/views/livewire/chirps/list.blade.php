...
new class extends Component {
    ...
    #[On('chirp-created')]
    function createChirp() : void {
        unset($this->chirps);
    }

    function edit(Chirp $chirp) : void {
        $this->editing = $chirp;
    }
    ...
    function delete(Chirp $chirp) : void {
...
<div class="mt-6 bg-white shadow-sm rounded-lg divide-y">
    @foreach ($this->chirps as $chirp)
        <div class="p-6 flex space-x-2" wire:key="chirper-{{ $chirp->id }}">
